...
public class FastVideoPlayerActivity extends AppCompatActivity implements MyHandler.Callback {

    private final String TAG = "FastVideoPlayerActivity";
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        progressDialog = ProgressDialog.show( FastVideoPlayerActivity.this, "Please wait", "The live stream is preparing.", true );
        ...
        try {
            ...
            fastVideoView.setOnErrorListener( new MediaPlayer.OnErrorListener() {
                ...
                public boolean onError( MediaPlayer mp, int what, int extra ) {
                    Log.i( "Exception", "error code :" + extra );
                    return false;
                }
            } );
            ...
            Log.d( TAG, "Video builder error : " + e.toString() );
        }
    }
    ...
    private class StreamingErrorListener implements MediaPlayer.OnErrorListener {
        @Override
        public boolean onError( MediaPlayer mp, int what, int extra ) {
            Log.d( TAG, "Streaming Error : " + what );
            return false;
        }
    }
    ...
    private class NetWorkStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive( Context context, Intent intent ) {
            ...
            Log.d( TAG, "MyBroadcastReceiver.onReceive( ", action, " )" );
