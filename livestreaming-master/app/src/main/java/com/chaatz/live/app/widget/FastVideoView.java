package com.chaatz.live.app.widget;
        ...
        if ( mVideoWidth > 0 && mVideoHeight > 0 ) {
            ...
            if ( widthSpecMode == MeasureSpec.EXACTLY && heightSpecMode == MeasureSpec.EXACTLY ) {
                ...
                if ( mVideoWidth * height < width * mVideoHeight ) {
                    Log.i( "FastVideoView : ", "image too wide, correcting\nwidthSpecSize : " + width + "\nheightSpecSize : " + height );
                    width = height * mVideoWidth / mVideoHeight;
                    Log.i( "FastVideoView : ", "Adjusted width : " + width );
                } else if ( mVideoWidth * height > width * mVideoHeight ) {
                    Log.i( "FastVideoView : ", "image too tall, correcting\nwidthSpecSize : " + width + "\nheightSpecSize : " + height );
                    height = width * mVideoHeight / mVideoWidth;
                    Log.i( "FastVideoView : ", "Adjusted height : " + width +"\n"+mVideoHeight+"\n"+mVideoWidth );
                    Log.i( "FastVideoView : ", "Adjusted height : " + height );
                }
