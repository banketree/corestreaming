...
import com.eotu.corestreaming.demo7.http.TinyHttpServer;
import com.eotu.corestreaming.demo7.spydroid.SpydroidApplication;
import com.eotu.corestreaming.demo7.spydroid.api.CustomHttpServer;
import com.eotu.corestreaming.demo7.spydroid.api.CustomRtspServer;
...
public class SpydroidActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.demo7_spydroid);
	...
	class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public HandsetFragment getHandsetFragment() {
			if (device == HANDSET) {
				...
				return (HandsetFragment) getSupportFragmentManager().findFragmentById(R.id.handset_pager);
			}
		}
