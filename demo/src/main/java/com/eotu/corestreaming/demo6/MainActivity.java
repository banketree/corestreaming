package com.eotu.corestreaming.demo6;
...
import com.eotu.corestreaming.demo6.http.WebServerService;
...
public class MainActivity extends Activity implements OnClickListener,
	...
	private SharedPreferences mSdpShared;
	

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.demo6_activity_main_6);
		...
		mSdpShared = getSharedPreferences("SDP", Context.MODE_PRIVATE);
	...
	public void onSessionConfigured() {
		...
		mSdpShared
				.edit()
				.putString("sdp_description",
						mSession.getSessionDescription()).commit();
		mSession.start();
	}
